...
const faqGroups = [
  {
    ...
    items: [
      ...
      ["整个充值流程需要多长时间？", "常规订单在支付确认后进入交付队列。自动支付回调成功时，系统会立即把订单状态改为“待交付”；人工核验场景需要客服根据付款截图处理。高峰期、企业大额采购或风控核验可能需要更久。"],
      ...
      <div class="checkout-layout">
        ...
        <form class="order-form reveal" id="orderForm">
          ...
          <label class="agreement-checkbox">
            ...
            <span>我已阅读并同意《用户须知与风险告知》、<a href="#/help" data-route="/help" target="_blank">《售后政策》</a>、<a href="#/priv" data-route="/priv" target="_blank">《隐私政策》</a>和<a href="#/tos" data-route="/tos" target="_blank">《服务条款》</a>，确认本人具备合法购买和使用资格，承诺不将服务用于任何违法违规或违反第三方平台规则的用途，并自行承担因非官方渠道、账号状态、支付风控、平台政策变化及本人操作不当产生的相应风险。</span>
          </label>
...
function termsPolicy() {
  return `
    <p class="effective">生效日期：2025年10月20日　最后更新：2026年06月30日</p>
    ${policySection("1. 用户须知与风险告知", [
...
Promise.all([loadPublicData(), loadSiteConfig(), trackVisitor()]).finally(render);
